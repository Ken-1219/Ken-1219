...
- ☁️ **Cloud-native SaaS platforms** on AWS  
...
- ⚙️ Designing **real-time systems** (SSE, WebSockets, GraphQL subscriptions)  
- ☁️ **AWS infrastructure trade-offs** (ECS vs Lambda, orchestration with Step Functions)  
- ⚛️ **Scaling Next.js applications** (caching, streaming, API design)  
...
- I’ve built **production systems used by real companies** *before graduating* —  
  and I care far more about **shipping reliable systems** than chasing shiny abstractions.
...
- Add a short projects section with links to live demos or repos
- Create a LICENSE (MIT) file and CONTRIBUTING.md
- Generate a small GitHub Actions workflow to validate README links and badges
